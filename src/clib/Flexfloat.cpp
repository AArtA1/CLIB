...
//
Flexfloat Flexfloat::normalise(stype cur_sign, eexttype cur_exp,
                               mexttype cur_mant, Etype E, Mtype M, Btype B) {
#ifndef NDEBUG
    CLOG(trace)
